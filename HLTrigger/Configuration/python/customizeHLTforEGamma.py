...
def customiseEGammaEventContent(process):
    ...
    process.load("RecoEgamma.EgammaHLTProducers.hltEgammaHLTPhase2Extra_cfi")

    process.hltEgammaHLTPhase2Extra.egTrigObjs = cms.InputTag("hltEgammaHLTExtra","L1Seeded")
    ...
    egammaEvtContent = [
        ...
        # --- Phase2 additions ---
        'keep *_hltEgammaHLTPhase2Extra_*_*',
        'keep *_countHgcalRecHits*_*_*',
    ...
    process.EgHLTExtraPath = cms.Path(process.hltEgammaHLTExtra + process.hltEgammaHLTPhase2Extra)
    if hasattr(process,"schedule") and process.schedule:
